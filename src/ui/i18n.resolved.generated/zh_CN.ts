...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "fish": {
        "startHeading": "入门",
        "startBody": "一根简易钓竿在东溪镇的渔夫布兰特处只卖20枚铜币（他在镇子东缘眺望着镜湖）；技工吉泽尔、芬桥镇的物资官黑尔和高望要塞的军需官布莉也有存货。面向前方约24码内足够深的水面使用鱼竿即可抛竿。战斗中、游泳时或死亡时无法抛竿：站在岸上钓才是正途，任何区域的可钓水域都行。",
        "biteHeading": "咬钩与收线",
      ...
      "faq": {
        ...
        "q6": "“由某某制作”是什么意思？",
        "a6": "九种通用的野外配方与工具配方人人从一开始便已知晓，三种绑定作业台的配方（窑鳞披肩、织卫兜帽与暮影裹手）也是如此，它们无需训练师，只需对应的作业台。其余一切都由三座枢纽城镇中各作业台旁的常驻师傅传授：多数在东溪镇，制革师守着芬桥镇的制革场，炼金大师守着高望要塞的药坊。\n\n训练师配方分为技能0点、25点、50点三档，作为一次性费用分别是免费、25银币和1金币。当你在该专业的熟练度达到配方自身的门槛时，师傅便会传授，而且学习时你必须站在其作业台旁：便携作业台不算数。",
        "q7": "什么是制作者之约？",
