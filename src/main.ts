    ...
    jsonLd.textContent = JSON.stringify(
      {
        ...
        '@graph': [
          {
            '@type': 'WebSite',
            '@id': 'https://worldofclaudecraft.aoruantech.com/#website',
            ...
            publisher: {
              '@id': 'https://worldofclaudecraft.aoruantech.com/#organization',
            },
          },
          {
            '@type': 'Organization',
            '@id': 'https://worldofclaudecraft.aoruantech.com/#organization',
            name: 'World of ClaudeCraft',
            url: 'https://worldofclaudecraft.aoruantech.com/',
            logo: 'https://worldofclaudecraft.aoruantech.com/woc_logo_square.webp',
            sameAs,
          },
          {
            '@type': 'VideoGame',
            '@id': 'https://worldofclaudecraft.aoruantech.com/#game',
            name: 'World of ClaudeCraft',
            alternateName: 'World of Claudecraft',
            genre: t('seo.genre'),
            ...
            url: canonicalHref,
            image: 'https://worldofclaudecraft.aoruantech.com/woc_logo_square.webp',
            description: t('seo.description'),
            inLanguage: languageTag(lang),
            publisher: {
              '@id': 'https://worldofclaudecraft.aoruantech.com/#organization',
...
// Default to disabled ('1') for China/domestic releases unless explicitly enabled with '0'
const DISCORD_BUILD_ENABLED = String(import.meta.env.VITE_DISCORD_DISABLED ?? '1').trim() === '0';
