...
export const TEMPLE_ITEMS: Record<string, ItemDef> = {
  ...
  drownstep_slippers: {
    ...
    slot: 'feet',
    quality: 'rare',
    stats: { armor: 35, int: 5, spi: 3, sta: 3 },
    sellValue: 1400,
    requiredClass: MAG,
  },
  drownstep_treads: {
  ...
  moonshroud_robe: {
    ...
    slot: 'chest',
    quality: 'rare',
    stats: { armor: 70, int: 10, spi: 5, sta: 4 },
    sellValue: 2400,
    requiredClass: MAG,
  },
  moonshroud_tunic: {
  ...
  tidehymn_slippers: {
    ...
    stats: { armor: 40, int: 2, spi: 2, sta: 1 },
    sellValue: 430,
  },
  pearlward_aegis: {
    id: 'pearlward_aegis',
    ...
    // requiredClass list.
    blockValue: 12,
    stats: { armor: 240, int: 5, spi: 3, sta: 3 },
    sellValue: 1700,
