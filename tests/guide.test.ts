...
describe('Guide entry wiring', () => {
  ...
  it('lists the guide in the sitemap', () => {
    expect(sitemapXml).toContain('<loc>https://worldofclaudecraft.aoruantech.com/wiki</loc>');
  });
...
describe('guide.html shell', () => {
  ...
  it('ships crawlable canonical + social metadata for /wiki', () => {
    expect(guideHtml).toContain(
      '<link rel="canonical" href="https://worldofclaudecraft.aoruantech.com/wiki" />',
    );
    expect(guideHtml).toContain(
      '<meta property="og:url" content="https://worldofclaudecraft.aoruantech.com/wiki" />',
    );
